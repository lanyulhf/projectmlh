...
gulp.task("copyhtml",function(){
	...
	gulp.src("*.html").pipe(gulp.dest("D:\\phpStudy\\WWW\\projectmlh\\productdetails"));
});
gulp.task("copyjs",function(){
	//gulp.src("index.html").pipe(gulp.dest("dist"));
	gulp.src("js/*.js").pipe(gulp.dest("D:\\phpStudy\\WWW\\projectmlh\\productdetails\\js"));
});
...
gulp.task("concatjs",function(){
	...
	.pipe(gulp.dest("D:\\phpStudy\\WWW\\projectmlh\\productdetails\\js"));
});
